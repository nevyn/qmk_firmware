...
[BASE] = LAYOUT_gergo(
    ...
    KC_RSFT,               KC_A,  KC_S,   KC_D,   KC_F, KC_G, KC_BTN2,                       KC_RALT,  KC_H,    KC_J, KC_K, KC_L,   KC_SCLN, KC_QUOT,
    KC_LCTRL,                KC_Z,  KC_X,   KC_C,   KC_V, KC_B, KC_BTN1, KC_BTN3,    TG(MUTE), KC_PGDN,  KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_MINS,
